...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [500593.160547, 1081031.862183, 519059.754297, 1090694.445516], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:8908',
            //extent: [156147.671200, 608897.313600, 658879.562700, 1241119.387800],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([500593.160547, 1081031.862183, 519059.754297, 1090694.445516], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sitios arqueológicos registrados en el distrito Agua Caliente o San Francisco de Cartago, Costa Rica, para el año 2026</h2>';
        return titleElement;
    })(),
